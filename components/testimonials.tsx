...
const Testimonials = () => {
  return (
    <div className="p-4 md:px-12 md:py-44 max-w-5xl mx-auto">
      <Title title="Testimonios" subtitle="Review dos clientes" />
      ...
      <Carousel className="mx-10   mt-6">
        <CarouselContent className="gap-8">
          {dataTestimonials.map((testimonial) => (
            ...
            >
              <Avatar>
                <AvatarImage src={testimonial.imageUrl} alt="Perfil" />
                <AvatarFallback>CN</AvatarFallback>
              </Avatar>
              <div>
                <p className="main-h-12 text-2xl mt-4">{testimonial.name}</p>
